                    ...
                    case Level.Train_without_Distracters:
                        switch (state)
                        {
                            case 0:
                                ...
                                if (!trafficM.isPlaying)
                                    CreateState(CautiousnessSubTask.Stationary, Level.Train_without_Distracters, 100);        //THE TWO STATEMENTS ABOVE USED TO ONLY BE THIS ONE STATEMENT FOR BOTH TRAIN WITH AND TRAIN WITHOUT
